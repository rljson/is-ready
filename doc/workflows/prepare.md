...
- [Open is-ready the first time](#open-is-ready-the-first-time)
  ...
  - [Open is-ready with Vscode](#open-is-ready-with-vscode)
...
```bash
git clone https://github.com/rljson/is-ready.git
```
